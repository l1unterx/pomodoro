...
export default function SessionHistory({ points, period }: { points: WorkTimePoint[]; period: ChartPeriod }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="rounded-3xl border border-border bg-surface p-4 shadow-lg shadow-black/20 backdrop-blur-xl">
        {period === "year" ? (
      ...
      {selected && (
        <div className="flex flex-col gap-2 rounded-3xl border border-border bg-surface p-4 shadow-lg shadow-black/20 backdrop-blur-xl">
